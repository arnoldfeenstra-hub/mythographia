...
export const SEEDS = [
  ...group('primordial', [
    'Chaos (cosmogony)', 'Gaia', 'Uranus (mythology)', 'Tartarus', 'Eros', 'Erebus',
  ...
  ...group('titan', [
    ...
    'Coeus', 'Phoebe (Titaness)', 'Crius', 'Mnemosyne', 'Themis', 'Iapetus', 'Atlas (mythology)',
  ...
  ...group('hero', [
    ...
    'Memnon (mythology)', 'Orestes', 'Telemachus', 'Palamedes (mythology)', 'Idomeneus of Crete',
  ]),
  ...group('mortal', [
    'Paris (mythology)', 'Priam', 'Hecuba', 'Andromache', 'Cassandra', 'Helen of Troy', 'Penelope',
    'Clytemnestra', 'Electra', 'Iphigenia', 'Medea', 'Ariadne', 'Phaedra (mythology)',
    'Hippolytus (son of Theseus)', 'Minos', 'Pasiphaë', 'Daedalus', 'Icarus', 'Andromeda (mythology)', 'Danaë',
    ...
    'Aeson', 'Pelias', 'Aeëtes', 'Nausicaa', 'Alcinous', 'Laertes (father of Odysseus)', 'Anchises',
  ]),
  ...group('creature', [
  ...
  ...group('event', [
    'Titanomachy', 'Trojan War', 'Judgement of Paris', 'Labours of Hercules',
    'Argonauts', 'Golden Fleece', 'Seven against Thebes', 'Epigoni', 'Trojan Horse',
    "Pandora's box", 'Abduction of Persephone', 'Centauromachy', 'Amazonomachy', 'Golden apple', 'Sack of Troy', 'Returns from Troy',
    'Choice of Heracles',
  ]),
];
